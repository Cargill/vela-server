...
func TestLimits_EngineOpt_WithClient(t *testing.T) {
...
func TestLimits_EngineOpt_WithLogger(t *testing.T) {
...
func TestLimits_EngineOpt_WithSkipCreation(t *testing.T) {
...
func TestLimits_EngineOpt_WithContext(t *testing.T) {
	e := &Engine{config: new(config)}
